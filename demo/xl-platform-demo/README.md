...
## Step 2 - Import the inception YAML definition:
...
$ xl apply -f demo/inception/xl-deploy-devops-as-code-service.yaml
$ xl apply -f demo/inception/xl-release-devops-as-code-service.yaml
